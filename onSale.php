...
$products = $db->saleProdsForPagination($start_from, $limit);
$pr = $db->getSaleProducts();
    ...
    <div class="container">
        <div class="row">
            ...
            foreach ($products as $product) {
                $actualPrice = $product['prod_price'];
                ...
                echo '<div class="col-md-3 col-sm-6">
                                <div class="single-shop-product">
                                    ...
                                    <ins>$'. $disPrice . '</ins><del>$'. $product["prod_price"] . '</del>
...
for ($i = 1; $i <= $total_pages; $i++) {
    if ($_GET['page'] == $i) {
        $pagLink .= "<li class = 'active'><a href='onSale.php?page=" . $i . "'>" . $i . "</a></li>";
    } else {
        $pagLink .= "<li><a href='onSale.php?page=" . $i . "'>" . $i . "</a></li>";
    }
};
echo $pagLink . "</ul>";
?>
